	...
	while(running) {
		...
		*/
		...
		switch(c) {
			...
			case 'h':
				// Help
				//speech_play((word)&spFUHR, sizeof(spFUHR));
				speech_play((word)&spDINER, sizeof(spDINER));
